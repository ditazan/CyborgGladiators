...
// player stats
var playerInfo = {
  name: window.prompt("What is your cyborg's name?"),
  health: 100,
  attack: 10,
  money: 10,
  reset: function () {
...
console.log(
  ...
  playerInfo.health + " health, " + "$" + playerInfo.money
);
...
var fight = function (enemy) {
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    if (promptFight === "skip" || promptFight === "SKIP") {
      ...
      if (confirmSkip) {
        window.alert(
          playerInfo.name + " has decided to skip this fight. weenie!"
        );
...
var shop = function () {
  ...
  var shopOptionPrompt = window.prompt(
    "would you like to REFILL your health, UPGRADE ur pack, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE'."
  );
